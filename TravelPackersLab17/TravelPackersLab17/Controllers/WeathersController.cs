...
namespace TravelPackersLab17.Controllers
{
    public class WeathersController : Controller
    {
        ...
        public WeathersController(TravelPackersLab17Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("WeatherID,Climate,SuppliesID")] Weather weather)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WeatherID,Climate,SuppliesID")] Weather weather)
        {
