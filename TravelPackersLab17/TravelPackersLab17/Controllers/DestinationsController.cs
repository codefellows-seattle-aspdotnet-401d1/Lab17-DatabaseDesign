...
namespace TravelPackersLab17.Controllers
{
    public class DestinationsController : Controller
    {
        ...
        public DestinationsController(TravelPackersLab17Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DestinationID,Location,Country,WeatherID")] Destination destination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinationID,Location,Country,WeatherID")] Destination destination)
        {
