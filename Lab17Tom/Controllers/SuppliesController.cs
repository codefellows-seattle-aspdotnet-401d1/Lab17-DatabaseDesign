...
namespace Lab17Tom.Controllers
{
    public class SuppliesController : Controller
    {
        ...
        public SuppliesController(Lab17TomContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SupplyID,Name,Weight,Volume,Qty,WeatherID,IsRequired,DestinationID")] Supplies supplies)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SupplyID,Name,Weight,Volume,Qty,WeatherID,IsRequired,DestinationID")] Supplies supplies)
        {
